...
class Ticket(BaseModel):
    ...
    id: str
    record_type: Literal["INC", "PRB", "CHG", "RITM"]
    title: str
    description: str
    state: str
    priority: str
...
MOCK_DB: dict[str, Ticket] = {
    "INC0048102": Ticket(
        ...
        priority="P1", assignee="Maya Chen", assignment_group="SAP EWM Support", sla_status="BREACHED", sla_minutes=30, sentiment="Frustrated",
    ...
    "INC0048103": Ticket(
        ...
        priority="P2", assignee="Maya Chen", assignment_group="QMS Compliance Ops", sla_status="AT_RISK", sla_minutes=90, sentiment="Impatient",
    ...
    "PRB0019201": Ticket(
        ...
        priority="P1", assignee="Omar Rahman", assignment_group="Integration Middleware", sla_status="AT_RISK", sla_minutes=120, sentiment="Calm",
    ...
    "CHG0092100": Ticket(
        ...
        priority="P2", assignee="Elena Rossi", assignment_group="Integration Middleware", sla_status="ON_TRACK", sla_minutes=240, sentiment="Calm",
    ...
    "RITM0094101": Ticket(
        id="RITM0094101", record_type="RITM", title="Provision SAP EWM 1010 Sandbox Roles",
        description="Service request to provision approved SAP EWM 1010 sandbox roles for a project team.", state="Fulfillment",
        priority="P3", assignee="Priya Nair", assignment_group="SAP EWM Support", sla_status="ON_TRACK", sla_minutes=480, sentiment="Calm",
