...
function BreachBadge({ ticket }) {
  if (!ticket.is_breached || !ticket.breach_reason) return null
  return <span className="rounded-full border border-rose-500/50 bg-rose-950/60 px-2 py-1 text-xs font-bold text-rose-200">🚨 Breached · {ticket.breach_reason}</span>
}
